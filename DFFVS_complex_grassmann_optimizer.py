...
from manifolds.complex_grassman import ComplexGrassmann
from torch.optim.optimizer import Optimizer, required



class DFFVS_Cg(Optimizer):
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.99), eps=1e-8, eight_decay = 0):
        ...
        super(DFFVS_Cg, self).__init__(params, defaults)
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                gradst = grads - (grads*grads*grads).grad
                #
                gradst = p.grad.data
